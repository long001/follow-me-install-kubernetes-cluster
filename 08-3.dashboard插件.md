...
dashboard-metrics-scraper-7b8b58dc8b-t7n55   1/1     Running   0          104s
kubernetes-dashboard-6cfc8c4c9-77m9x         1/1     Running   0          104s
```
...
``` bash
[root@long-k8s-01 work] kubectl port-forward -n kubernetes-dashboard  svc/kubernetes-dashboard 4443:443 --address 0.0.0.0
```

浏览器访问 URL：`https://139.224.129.11:4443/`
...
登陆成功  
![images/dashboard.png](images/20200623102350.png)
